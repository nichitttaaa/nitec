  ...
  return (
    <div className="bg-[hsl(0,0%,97%)] rounded-4xl -z-2 w-60 h-55 p-4 flex flex-col relative justify-between items-center">
      <div className="flex justify-evenly relative w-full">
        <img
          className="size-15 border-3 border-white rounded-full"
          src={person1}
          alt=""
        />
        <img
          className="size-15 border-3 border-white rounded-full absolute "
          src={person2}
          alt=""
        />
        <img
      ...
      <div className="w-35 p-2 h-10 bg-white rounded-3xl flex items-center justify-center">
        <img className="size-5" src={star} alt="" />
        <span className="text-lg">4.6 reviews</span>
      </div>
    </div>
  );
}
