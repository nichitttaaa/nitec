...
function NavBar () {
    ...
    return (
        ...
        <div className="w-full h-[75px] bg-[#EAF1F1] rounded-4xl justify-between flex items-center  p-2">
            <div className="w-[150px] h-[60px] rounded-4xl  bg-[#E4EBED] flex items-center">
                <div className="ml-7">
            ...
            <div className=" flex items-center gap-4">
               <NavLink to="/cart" end>
                ...
                <button className="p-4 gap-2 rounded-full flex bg-white justify-center items-center cursor-pointer hover:border-black border border-transparent transition-all">
